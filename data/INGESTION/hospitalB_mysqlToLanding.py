...
#Google Cloud Storage (GCS) Configuartion
GCS_BUCKET = "healthdatastorage-bucket-4112025"
HOSPITAL_NAME = "hospital-b"
LANDING_PATH = f"gs://{GCS_BUCKET}/landing/{HOSPITAL_NAME}/"
ARCHIVE_PATH = f"gs://{GCS_BUCKET}/landing/{HOSPITAL_NAME}/archive/"
CONFIG_FILE_PATH = f"gs://{GCS_BUCKET}/configs/load_config.csv"

#BiQuery Configuration 
BQ_PROJECT = "hospitalproject-456516"
...
#MYSQL Configuration
MYSQL_CONFIG = {
    "url":"jdbc:mysql://104.154.26.167:3306/hospital_b_db?useSSl=false&allowPublickeyRetrival=true",
